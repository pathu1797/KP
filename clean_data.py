"""
Clean the KOI cumulative dataset.
Drops any column where > 50% of values are missing, then saves the result.
"""
...
MISSING_THRESHOLD = 0.50  # drop columns with more than 50% NaN
